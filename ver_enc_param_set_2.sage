...
logq1 = logp                            # log of the smallest prime divisor of q
...
m1 = M - N + 1                          # length of s1 = (randomness of length N - N = 5, message)
m2 = 0                                  # length of s2, to be determined
ell = 0                                 # length of m 
alpha = sqrt(rand_coeff^2*(M-N)*d + d)  # norm of s1
...
gamma1 = 9.5                            # rejection sampling for s1
